...
const countLayers = (arr) => [...new Set(arr)].length;


console.log(countLayers(["AAAA","ABBA","AAAA"])) 
//2
console.log(countLayers(["AAAAAAAAA","ABBBBBBBA","ABBAAABBA","ABBBBBBBA","AAAAAAAAA"])) 
//3
console.log(countLayers(["AAAAAAAAAAA","AABBBBBBBAA","AABCCCCCBAA","AABCAAACBAA","AABCADACBAA","AABCAAACBAA","AABCCCCCBAA","AABBBBBBBAA","AAAAAAAAAAA"])) 
// 5
